...
public class AddressBook {
	 ...
	 */
	private enum PERSON_DATA_INDEX {
		NAME, PHONE, EMAIL
	}
	 ...
	 */
	private static final ArrayList<HashMap<PERSON_DATA_INDEX, String>> ALL_PERSONS = new ArrayList<>();
	 ...
	 */
	private static ArrayList<HashMap<PERSON_DATA_INDEX, String>> latestPersonListingView = getAllPersonsInAddressBook(); // initial
	// view
	// is
	// of
	// all
	...
	private static String executeAddPerson(String commandArgs) {
		...
		final Optional<HashMap<PERSON_DATA_INDEX, String>> decodeResult = decodePersonFromString(commandArgs);
		...
		final HashMap<PERSON_DATA_INDEX, String> personToAdd = decodeResult.get();
	 ...
	 */
	private static String getMessageForSuccessfulAddPerson(HashMap<PERSON_DATA_INDEX, String> personToAdd) {
		return String.format(MESSAGE_ADDED, getNameFromPerson(personToAdd), getPhoneFromPerson(personToAdd),
				getEmailFromPerson(personToAdd));
	}
	...
	private static String executeFindPersons(String commandArgs) {
		...
		final ArrayList<HashMap<PERSON_DATA_INDEX, String>> personsFound = getPersonsWithNameContainingAnyKeyword(
				keywords);
	...
	private static String getMessageForPersonsDisplayedSummary(
			ArrayList<HashMap<PERSON_DATA_INDEX, String>> personsFound) {
	 ...
	 *         keywords
	 */
	private static ArrayList<HashMap<PERSON_DATA_INDEX, String>> getPersonsWithNameContainingAnyKeyword(
			Collection<String> keywords) {
		final ArrayList<HashMap<PERSON_DATA_INDEX, String>> matchedPersons = new ArrayList<>();
		for (HashMap<PERSON_DATA_INDEX, String> person : getAllPersonsInAddressBook()) {
	...
	private static String executeDeletePerson(String commandArgs) {
		...
		final HashMap<PERSON_DATA_INDEX, String> targetInModel = getPersonByLastVisibleIndex(targetVisibleIndex);
	 ...
	 */
	private static String getMessageForSuccessfulDelete(HashMap<PERSON_DATA_INDEX, String> deletedPerson) {
	...
	private static String executeListAllPersonsInAddressBook() {
		ArrayList<HashMap<PERSON_DATA_INDEX, String>> toBeDisplayed = getAllPersonsInAddressBook();
	...
	private static void showToUser(HashMap<PERSON_DATA_INDEX, String> person) {
		showToUser((String[]) person.values().toArray());
	}
	 ...
	 *
	 */
	private static void showToUser(ArrayList<HashMap<PERSON_DATA_INDEX, String>> persons) {
	 ...
	 */
	private static String getDisplayString(ArrayList<HashMap<PERSON_DATA_INDEX, String>> persons) {
		final StringBuilder messageAccumulator = new StringBuilder();
		for (int i = 0; i < persons.size(); i++) {
			final HashMap<PERSON_DATA_INDEX, String> person = persons.get(i);
	...
	private static String getIndexedPersonListElementMessage(int visibleIndex,
			HashMap<PERSON_DATA_INDEX, String> person) {
	 ...
	 */
	private static String getMessageForFormattedPersonData(HashMap<PERSON_DATA_INDEX, String> person) {
	 ...
	 */
	private static void updateLatestViewedPersonListing(ArrayList<HashMap<PERSON_DATA_INDEX, String>> newListing) {
	 ...
	 */
	private static HashMap<PERSON_DATA_INDEX, String> getPersonByLastVisibleIndex(int lastVisibleIndex) {
	 ...
	 */
	private static Collection<? extends HashMap<PERSON_DATA_INDEX, String>> loadPersonsFromFile(String filePath) {
		final Optional<ArrayList<HashMap<PERSON_DATA_INDEX, String>>> successfullyDecoded = decodePersonsFromStrings(
	 ...
	 *            file for saving
	 */
	private static void savePersonsToFile(ArrayList<HashMap<PERSON_DATA_INDEX, String>> arrayList, String filePath) {
	 ...
	 *            to add
	 */
	private static void addPersonToAddressBook(HashMap<PERSON_DATA_INDEX, String> personToAdd) {
	 ...
	 */
	private static boolean deletePersonFromAddressBook(HashMap<PERSON_DATA_INDEX, String> targetInModel) {
	 ...
	 */
	private static ArrayList<HashMap<PERSON_DATA_INDEX, String>> getAllPersonsInAddressBook() {
		return ALL_PERSONS;
	}
	 ...
	 */
	private static void initialiseAddressBookModel(Collection<? extends HashMap<PERSON_DATA_INDEX, String>> persons) {
		ALL_PERSONS.clear();
	 ...
	 *            whose name you want
	 */
	private static String getNameFromPerson(HashMap<PERSON_DATA_INDEX, String> person) {
		return person.get(PERSON_DATA_INDEX.NAME);
	}
	 ...
	 */
	private static String getPhoneFromPerson(HashMap<PERSON_DATA_INDEX, String> person) {
		return person.get(PERSON_DATA_INDEX.PHONE);
	}
	 ...
	 */
	private static String getEmailFromPerson(HashMap<PERSON_DATA_INDEX, String> person) {
		return person.get(PERSON_DATA_INDEX.EMAIL);
	}
	 ...
	 */
	private static HashMap<PERSON_DATA_INDEX, String> makePersonFromData(String name, String phone, String email) {
		final HashMap<PERSON_DATA_INDEX, String> person = new HashMap<PERSON_DATA_INDEX, String>();
		person.put(PERSON_DATA_INDEX.NAME, name);
		person.put(PERSON_DATA_INDEX.NAME, phone);
		person.put(PERSON_DATA_INDEX.NAME, email);
		return person;
	}
	 ...
	 */
	private static String encodePersonToString(HashMap<PERSON_DATA_INDEX, String> person) {
	 ...
	 */
	private static ArrayList<String> encodePersonsToStrings(ArrayList<HashMap<PERSON_DATA_INDEX, String>> arrayList) {
		final ArrayList<String> encoded = new ArrayList<>();
		for (HashMap<PERSON_DATA_INDEX, String> person : arrayList) {
	 ...
	 *         decoded person
	 */
	private static Optional<HashMap<PERSON_DATA_INDEX, String>> decodePersonFromString(String encoded) {
		// check that we can extract the parts of a person from the encoded
		// string
		if (!isPersonDataExtractableFrom(encoded)) {
			return Optional.empty();
		}
		final HashMap<PERSON_DATA_INDEX, String> decodedPerson = makePersonFromData(
				extractNameFromPersonString(encoded), extractPhoneFromPersonString(encoded),
	 ...
	 *         decoded persons
	 */
	private static Optional<ArrayList<HashMap<PERSON_DATA_INDEX, String>>> decodePersonsFromStrings(
			ArrayList<String> encodedPersons) {
		final ArrayList<HashMap<PERSON_DATA_INDEX, String>> decodedPersons = new ArrayList<>();
		for (String encodedPerson : encodedPersons) {
			final Optional<HashMap<PERSON_DATA_INDEX, String>> decodedPerson = decodePersonFromString(encodedPerson);
	 ...
	 */
	private static boolean isPersonDataValid(HashMap<PERSON_DATA_INDEX, String> decodedPerson) {
		return isPersonNameValid(decodedPerson.get(PERSON_DATA_INDEX.NAME))
				&& isPersonPhoneValid(decodedPerson.get(PERSON_DATA_INDEX.PHONE))
				&& isPersonEmailValid(decodedPerson.get(PERSON_DATA_INDEX.EMAIL));
	}
